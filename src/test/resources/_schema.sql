...
CREATE TABLE `order_item` (
  ...
  KEY `fk_orde_items_product_idx` (`product_id`),
  CONSTRAINT `fk_orde_items_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
